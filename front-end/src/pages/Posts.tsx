...
const Posts = () => {
    ...
    const [postsByYear, setPostsByYear] = useState<PostsInterface[]>([]);

    const transformPostToPostByYear = (
        posts: PostInterface[]
    ): PostsInterface[] => {
        const yearMap = new Map<number, PostInterface[]>();
        ...
        const result: PostsInterface[] = Array.from(
            yearMap,
            ([year, posts]) => ({
                year,
                posts,
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => {
                const rawPosts: PostInterface[] = res.data;
                ...
                setPost(parsedPosts);
                const groupedPosts = transformPostToPostByYear(parsedPosts);
